...
<script language="javascript">
	...
	document.write("bordercolor=#ddd width=100%><font color=black>");
	document.write("<tr><td colspan='7' bgcolor='grey' style='border-radius:px; -moz-border-radius:px; -webkit-border-radius:px;'><center><strong><font size=2 face=tahoma>" 
	...
	document.write("<hr><b>&raquo; Hari ini : " 
	+ thisdate + " " + monthnames[thismonth] + " " + thisyear 
	+ " &laquo;</b>")
	// End -->
</script>
</center>