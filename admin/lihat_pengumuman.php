...
$tgl_ind=report_date($data_date);
		echo("<table width='100%'>
			...
			<a style='cursor:pointer;' border='0' onclick=\"javascript:window.location.href='index.php?page=pengumuman';\"><img src='images/back.png' title='Kembali ke daftar pengumuman' alt='Kembali' width='30' height='30' border='0' /></a>");
?>
</div>