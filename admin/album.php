...
<form method="POST" style="display:inline-block; " action="index.php?page=album">
	<?php
...
<form method="POST" action="index.php?page=album_proses" enctype="multipart/form-data">
...
<table class="table">
	...
	if($jumlah == 0){
		...
		$f = mysql_num_rows($d);
			...
			echo "<td align='center'><img src='images/b_browse.png' title='Lihat' border='0' onclick=\"javascript:window.location.href='index.php?page=lihat_album&id=$b[id]';\"></td>";
			echo "<td align='center'><img src='images/b_edit.png' title='Edit' border='0' onclick=\"javascript:window.location.href='index.php?page=album_edit&id=$b[id]';\"></td>";
			echo "<td align='center'> <img src='images/trash.png' title='Hapus' border='0' onclick=\"javascript: if(confirm('Data ingin dihapus ?')==true){window.location.href='index.php?page=album_proses&id=$b[id]&aksi=hapus';}\"/></td>";
			echo "</tr>";
			$no++;
		}
	}		
