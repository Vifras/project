...
switch($_REQUEST['aksi'])
{
	...
	echo "<meta http-equiv='refresh' content='0;url=index.php?page=lihat_album&id=$idx'/>";
	break;
	...
	echo "<meta http-equiv='refresh' content='0;url=index.php?page=lihat_album&id=$id'/>";
	break;
