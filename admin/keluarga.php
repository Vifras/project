...
<table class="table">
	...
	if($jumlah == 0){
		...
		while($b = mysql_fetch_array($a)){
			...
			echo "<td align='center'><img src='images/b_browse.png' title='Lihat' border='0' onclick=\"javascript:window.location.href='index.php?page=lihat_kk&id=$b[no_kk]';\"></td>";
			/*echo "<td align='center'><img src='images/b_usrlist.png' title='Tambah' border='0' onclick=\"javascript:window.location.href='index.php?page=penduduk_tambah&id=$b[no_kk]';\"></td>";*/
