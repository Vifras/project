	...
	<table width="100%" style="margin-left:10px; margin-top:5px;">
		...
		<tr>
			<td colspan="2">
				...
				<?php 
				echo "<a style='cursor:pointer;' title='Lihat Kartu Keluarga' border='0' onclick=\"javascript:window.location.href='index_petugas.php?page=lihat_kk&id=$hasil[no_kk]';\">Back</a>";
				?>
