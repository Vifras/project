...
<form method="POST" style="display:inline-block; " action="index_petugas.php?page=lihat_album&id=<?php echo $id ?>">
	<?php
...
<form method="POST" action="index_petugas.php?page=album_detail_proses" enctype="multipart/form-data">
...
<table class="table">
	...
	if($jumlah == 0){
		...
		while($b = mysql_fetch_array($a)){
			...
			echo "<td align='center'><img src='images/b_edit.png' title='Edit' border='0' onclick=\"javascript:window.location.href='index_petugas.php?page=album_detail_edit&id=$b[id]&idx=$b[id_alb]';\"></td>";
			echo "<td align='center'> <img src='images/trash.png' title='Hapus' border='0' onclick=\"javascript: if(confirm('Data ingin dihapus ?')==true){window.location.href='index_petugas.php?page=album_detail_proses&idx=$b[id_alb]&id=$id&aksi=hapus';}\"/></td>";
			echo "</tr>";
			$no++;
		}
	}		
...
echo "&nbsp; | <a href='index_petugas.php?page=album'>Kembali</a>";
//Link untuk Prev
echo "<center>";
if($start !=0){
