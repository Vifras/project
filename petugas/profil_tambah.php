...
<form method="POST" action="index_petugas.php?page=profil_proses" enctype="multipart/form-data">
	...
	<table width="100%" style="margin-left:10px; margin-top:5px;">
		...
		<tr>
			<td colspan="2">
				...
				<?php 
				echo "<a style='cursor:pointer;' title='Lihat profil' border='0' onclick=\"javascript:window.location.href='index_petugas.php?page=profil';\">Lihat profil</a>";
				?>
			</td>
		</tr>
	</table>
